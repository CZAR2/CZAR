...
or redis:get(CZAR..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_)) and MsgText[1] ~= "الغاء" and is_JoinChannel(msg) then 
return false end 
...
if MsgText[1] == "تعديلاتي" or MsgText[1] == "سحكاتي" and is_JoinChannel(msg) then    
...
if MsgText[1] == "تغير الرتبه" and is_JoinChannel(msg) then
...
if MsgText[1] == "قائمه الرتب" and is_JoinChannel(msg) then
if not msg.Creator  then return "⌁︙ هذا الامر يخص {المنشئ الاساسي,المطور} فقط  \n" end
...
if MsgText[1] == "المالك"  or MsgText[1] == "المنشئ" or  MsgText[1] == "المنشى" and is_JoinChannel(msg) then
...
if v.status == "creator" and v.user.first_name ~= "" and is_JoinChannel(msg) then
...
if MsgText[1] == "المجموعه" and is_JoinChannel(msg) then
...
if MsgText[1] == "الغاء التثبيت" and is_JoinChannel(msg) then
if not msg.Admin then return "⌁︙ هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
...
if UserID == our_id then 
return sendMsg(arg.ChatID,arg.MsgID,"⌁*︙* عذرا لا يمكنني رفع البوت \n⌁") 
elseif data.type_.ID == "ChannelChatInfo" and is_JoinChannel(msg) then 
return sendMsg(arg.ChatID,arg.MsgID,"⌁*︙* عذرا هذا معرف قناة وليس حساب \n⌁") 
end
UserName = arg.UserName
...
if MsgText[1] == "تنزيل ادمن" and is_JoinChannel(msg) then
if not msg.Director then return "⌁︙ هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not MsgText[2] and msg.reply_id then
GetMsgInfo(msg.chat_id_,msg.reply_id,function(arg,data)
if not data.sender_user_id_ then return sendMsg(arg.ChatID,arg.MsgID,"⌁*︙* عذرا هذا العضو ليس موجود ضمن المجموعات \n❕") end
...
if MsgText[1] == "التفاعل" and is_JoinChannel(msg) then
if not MsgText[2] and msg.reply_id then
GetMsgInfo(msg.chat_id_,msg.reply_id,function(arg,data)
if not data.sender_user_id_ then return sendMsg(arg.ChatID,arg.MsgID,"⌁*︙* عذرا هذا العضو ليس موجود ضمن المجموعات \n❕") end
local UserID = data.sender_user_id_
...
if MsgText[1] == "كشف" and is_JoinChannel(msg) then
if not MsgText[2] and msg.reply_id then 
GetMsgInfo(msg.chat_id_,msg.reply_id,function(arg,data)
if not data.sender_user_id_ then return sendMsg(arg.ChatID,arg.MsgID,"⌁*︙* عذرا هذا العضو ليس موجود ضمن المجموعات \n❕") end
local UserID = data.sender_user_id_
...
if MsgText[1] == "رفع القيود" and is_JoinChannel(msg) then
if not msg.Admin then return "⌁︙ هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if not MsgText[2] and msg.reply_id then 
GetMsgInfo(msg.chat_id_,msg.reply_id,function(arg,data)
if not data.sender_user_id_ then return sendMsg(arg.ChatID,arg.MsgID,"⌁*︙* عذرا هذا العضو ليس موجود ضمن المجموعات \n❕") end
...
if MsgText[1] == "رفع مشرف" and is_JoinChannel(msg) then
...
if MsgText[1] == "تنزيل مشرف" and is_JoinChannel(msg) then
if not msg.Creator then return "⌁︙ هذا الامر يخص {منشئ اساسي,المطور} فقط  \n" end
...
if MsgText[1] == "انشاء رابط" and is_JoinChannel(msg) then
if not msg.Creator then return "⌁︙ هذا الامر يخص {المطور,المنشئ الاساسي ,المنشئ} فقط  \n" end
...
if MsgText[1] == "ضع تكرار" and is_JoinChannel(msg) then
if not msg.Admin then return "⌁︙ هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
...
if MsgText[1] == "ضع وقت التنظيف" and is_JoinChannel(msg) then
...
if MsgText[1] == "مسح المنشئيين الاساسيين" or MsgText[1] == "مسح المنشئين الاساسيين" or MsgText[1] == "مسح المنشئيين الاساسين" or MsgText[1] == "مسح المنشئين الاساسين" and is_JoinChannel(msg) then 
if not msg.SudoUser then return "⌁︙ هذا الامر يخص {المطور} فقط  \n" end
...
if MsgText[1] == "مسح التعديلات"  or MsgText[1] == "مسح سحكاتي" or MsgText[1] == "مسح تعديلاتي" and is_JoinChannel(msg) then    
redis:del(CZAR..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
return "⌁︙ تم مسح جميع سحكاتك" 
end

if MsgText[1] == "مسح الادمنيه" and is_JoinChannel(msg) then 
if not msg.Director then return "⌁︙ هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
