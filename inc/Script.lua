...
redis:set(CZAR..'num_msg_max'..msg.chat_id_,MsgText[2]) 
...
if not msg.Director then return "📪¦ هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local list = redis:hgetall(CZAR..":AwamerBotArray2:"..msg.chat_id_)
local list2 = redis:hgetall(CZAR..":AwamerBotArray:"..msg.chat_id_)
...
if not msg.Director then return "📪¦ هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Awammer 	= redis:del(CZAR..":AwamerBot:"..msg.chat_id_)
redis:del(CZAR..":AwamerBotArray:"..msg.chat_id_)
redis:del(CZAR..":AwamerBotArray2:"..msg.chat_id_)
if Awammer ~= 0 then
...
for k, CZAR in pairs(XCZAR) do if MsgText[2]:match(CZAR) then  checkAmr = true end end      
if checkAmr then
redis:setex(CZAR..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_,300,MsgText[2])
return "📭¦ حسننا عزيزي , لتغير امر {* "..MsgText[2].." *}  ارسل الامر الجديد الان \n..."
else
return "📛*¦* عذرا لا يوجد هذا الامر في البوت لتتمكن من تغييره  \n"
end
else
redis:setex(CZAR..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Director then return "📪¦ هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if MsgText[2] then
local checkk = redis:hdel(CZAR..":AwamerBotArray2:"..msg.chat_id_,MsgText[2])
...
redis:setex(CZAR..":Witting_AmrDel:"..msg.chat_id_..msg.sender_user_id_,300,true)
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(CZAR..":awamer_Klesha_mf:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
📋┇ [Explanation Channel](https://t.me/SourceCZAR/1)

┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
📮┇ [Source Programmer](https://t.me/TH3CZAR)

♻️┇ [Twasl Bot Programmer](https://t.me/TH3CZARBOT)
...
if msg.SuperCreator and redis:get(CZAR..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_) then 
...
if msg.edited and not msg.SuperCreator and redis:get(CZAR.."antiedit"..msg.chat_id_) then 
...
local NUM_MSG_MAX = (redis:get(CZAR..'num_msg_max'..msg.chat_id_) or 5)
