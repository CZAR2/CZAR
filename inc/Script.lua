...
if MsgText[1] == "الحمايه" and is_JoinChannel(msg)  then 
if not msg.Admin then return "⌁︙ هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
return settingsall(msg) 
end

if MsgText[1] == "الاعدادات" and is_JoinChannel(msg)  then 
if not msg.Admin then return "⌁︙ هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
return settings(msg) 
end

if MsgText[1] == "الوسائط" and is_JoinChannel(msg) then 
if not msg.Admin then return "⌁︙ هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
return media(msg) 
end
...
if MsgText[1] == "الاداريين" and is_JoinChannel(msg)  then 
if not msg.Director  then return "⌁︙ هذا الامر يخص {المدير,المنشئ,المطور} فقط  \n" end
...
if Text == "تفعيل الاشتراك" and msg.SudoUser then
...
if Text and (Text:match("^ضع القناه$")) and msg.SudoUser then
sendMsg(msg.chat_id_,msg.id_,'ارسل معرفك بدون @')
redis:setex(CZAR..'setchs',120,true)
end
if Text == "تعطيل الاشتراك" and msg.SudoUser then
