...
var = redis:get(CZAR..":RtbaNew3:"..ChatID) or ' المنشىء اساسي👷🏽' 
elseif redis:sismember(CZAR..':MONSHA_BOT:'..ChatID,UserID) then
var = redis:get(CZAR..":RtbaNew4:"..ChatID) or ' المنشىء 👷🏽' 
elseif redis:sismember(CZAR..'owners:'..ChatID,UserID) then
var = redis:get(CZAR..":RtbaNew5:"..ChatID) or 'مدير البوت 👨🏼‍⚕️' 
elseif redis:sismember(CZAR..'admins:'..ChatID,UserID) then
var = redis:get(CZAR..":RtbaNew6:"..ChatID) or 'ادمن في البوت 👨🏼‍🎓' 
elseif redis:sismember(CZAR..'whitelist:'..ChatID,UserID) then
var = redis:get(CZAR..":RtbaNew7:"..ChatID) or 'عضو مميز ⭐️' 
else
var = 'فقط عضو 🙍🏼‍♂️' 
end
return var
...
.."\n⚜️¦ الماركدوان » "..(redis:get(CZAR..'lock_markdown'..msg.chat_id_) or 'false')
