...
name = katu[math.random(#katu)]
redis:set(CZAR..':Set_Arg:'..msg.chat_id_,name)
...
✠︙•⊱ الالعاب لبوت []]..redis:get(CZAR..':NameBot:')..[[]  ، ! 
✠︙•⊱ الالعاب لبوت ۰۪۫C۪۫۰۰۪۫Z۪۫۰۰۪۫A۪۫۰۰۪۫R۪۫۰
  ، ! 
✠︙•⊱ لتفعيل الالعاب او تعطيلها ارسل
✠︙•⊱ تفعـيل ⊰• تعطيل •⊱ الالعاب
ꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ
...
if redis:get(CZAR.."chencher"..msg.sender_user_id_) then 
if redis:get(CZAR.."chencher"..msg.sender_user_id_) ~= data.first_name_ then 
tahan = '['..(redis:get(CZAR.."chencher"..msg.sender_user_id_) or '')..']'
taham = '['..data.first_name_..']'
local taha ={ 
'\nمــي تسلم عليك وتقولك ليش مغير اسمك يالطيب الاول احلى 🤔',
'\n 👀 يا ( '..taham.. ') \n ما كان الاسم قبـل \n '..tahan..' 🤭😏',
}
sendMsg(msg.chat_id_,msg.id_,taha[math.random(#taha)])
end  
end
redis:set(CZAR.."chencher"..msg.sender_user_id_, data.first_name_) 
end,nil) 
end
end
return {
