...
---------------Lock en-------------------
function lock_enhso(msg)
if not msg.Admin then return "✠︙ هذا الامر يخص الادمنيه فقط  " end
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(CZAR.."lock_enhso"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒︙ تم بالتأكيد قفل الانكيزيه    \n✠︙ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(CZAR.."lock_enhso"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"🔒︙ تم قفل الفارسيه الانكيزيه   \n✠︙ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end

function unlock_enhso(msg)
if not msg.Admin then return "✠︙ هذا الامر يخص الادمنيه فقط  " end
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(CZAR.."lock_enhso"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"✠︙ تم بالتأكيد فتح الانكليزيه    \n✠︙ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(CZAR.."lock_enhso"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"✠︙ تم فتح الفارسيه الانكليزيه   \n✠︙ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
redis:del(CZAR..'mute_text'..msg.chat_id_,true)
return '✠*︙*أهلا عزيزي '..msg.TheRankCmd..'\n✠*︙*تــ✓ــم فتح الدردشه \n✓'
end
end
---------------Mute photo-------------------
